...
export default {
 ...
 destroyed(){
   ...
   const socket = socketio("http://34.199.8.152:5000");
  ...
  mounted() {
        let vm=this
        // var client_key=''
        // axios.get('http://34.199.8.152:5000/newid').then(function(response){
...
const socket = socketio("http://34.199.8.152:5000");
  socket.on("connect",()=>{
    ...
    // var vm = this;
    axios
      .get("http://34.199.8.152:5000/getsongs?room_key=" + vm.room_key)
