...
export default {
    ...
    created(){
        let vm = this
        axios.get(`http://digitaldj.live:5000/settings/username?email=${vm.email}`)
    ...
    methods:{
        changeUsername:function(){
            let vm = this
            axios.post('http://digitaldj.live:5000/settings/username', {"email":this.email, "username":this.username})
            .then(function(response){
        ...
        changePassword:function(){
            if (this.newPassword == this.newPasswordValid){
                axios.post('http://digitaldj.live:5000/settings/password', {"email":this.email, "password":this.password, "newpassword":this.newPassword})
            }
        }
    }
}
