...
export default {
    ...
    created(){
        let vm = this
        axios.get(`http://api.digitaldj.live/settings/username?email=${vm.email}`)
    ...
    methods:{
        changeUsername:function(){
            let vm = this
            axios.post('http://api.digitaldj.live/settings/username', {"email":this.email, "username":this.username})
            .then(function(response){
        ...
        changePassword:function(){
            if (this.newPassword == this.newPasswordValid){
                axios.post('http://api.digitaldj.live/settings/password', {"email":this.email, "password":this.password, "newpassword":this.newPassword})
            }
        }
    }
}
